...
#import "UITextView+XBMasonryKit.h"
#import <objc/runtime.h>
@implementation UITextView (XBMasonryKit)
...
+(instancetype)xb_textViewWithFontSize:(CGFloat)fontSize
    ...
    return [self xb_textViewWithFontSize:fontSize textColor:textColor borderColor:nil borderWidth:0 cornerRadiu:0 placeColor:placeColor placeText:placeText superView:superView constraints:constraints];
}
...
+(instancetype)xb_textViewWithFontSize:(CGFloat)fontSize
    ...
    [textView xb_textViewsSetPlaceholderWithText:placeText Color:placeColor];
